                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div class="relative">
                        ...
                        <input id="password" name="password" type="password" autocomplete="new-password" required
                            class="appearance-none rounded-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"
                            placeholder="Password">
                        <button type="button" id="toggle-password"
                            class="absolute inset-y-0 right-0 pr-3 flex items-center text-sm leading-5">
                            <!-- Show icon (visible when password is hidden) -->
                            ...
                            <!-- Hide icon (visible when password is shown) -->
                    ...
                    <div class="relative">
                        ...
                        <input id="password_confirmation" name="password_confirmation" type="password"
                            ...
                            class="appearance-none rounded-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-green-500 focus:border-green-500 focus:z-10 sm:text-sm"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function toggleVisibility(input, button) {
            ...
            button.querySelector('.show-icon').classList.toggle('hidden');
            button.querySelector('.hide-icon').classList.toggle('hidden');
        }
